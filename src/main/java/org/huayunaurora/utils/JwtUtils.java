...
public class JwtUtils {
    ...
    private final String ISSUER = "huayunaurora";
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        return createToken(claims, userDetails.getUsername(), 1000 * 60 * 60 * 2);
    }

    public String generateTokenByOidcUser(OidcUser userDetails) {
        Map<String, Object> claims = new HashMap<>();
        return createToken(claims, userDetails.getAttribute("email"), 1000 * 60 * 60 * 2);
    }
